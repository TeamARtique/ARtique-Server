...
export default async (req: Request, res: Response) => {
    ...
    if (!exhibitionId || !userId || !req.body.title || !req.body.category || !req.body.posterImage || req.body.posterTheme == null || !req.body.posterOriginalImage || !req.body.description || !req.body.tag) {
    ...
    const exhibitionData: exhibitionDTO = {
        ...
        posterOriginalImage: req.body.posterOriginalImage,
        posterTheme: req.body.posterTheme,
    ...
    try {
        ...
        let finalData = {
            exhibition: {
                ...
                posterOriginalImage: exhibitionData.posterOriginalImage,
